...
class e3tmadRequestingReportingComponent extends Component {
  constructor(props) {
    super(props);
        ...
        this.setState(
          {
            resultToExport: [
              ...data.results.map((r, i) => ({ no: i + 1, ...r })),
              {
                ...
                json_props: { municipality_name: [`${data.count} معاملة`] },
              },
            ], //data.results,
          },
          () => {
...
export const e3tmadRequestingReporting = withRouter(
  connect(
    mapStateToProps,
    mapDispatchToProps
  )(withTranslation("tabs")(e3tmadRequestingReportingComponent))
);
