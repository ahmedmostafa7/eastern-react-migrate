...
class splitmergeRequestingReportingComponent extends Component {
  constructor(props) {
    super(props);
...
export const splitmergeRequestingReporting = withRouter(
  connect(
    mapStateToProps,
    mapDispatchToProps
  )(withTranslation("tabs")(splitmergeRequestingReportingComponent))
);
