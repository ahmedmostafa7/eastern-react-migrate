...
export const UPDATING_SUBMISSIONS = ({ id: appId }) => ({
  number: 2,
  label: "Deedgenerated",
  name: "UPDATING_SUBMISSIONS",
  moduleName: "UPDATING_SUBMISSIONS",
  apiUrl: `/submission/GetRunningSubmissions/deedgenerated/${appId}`,
  content: {
    type: "tabsTable",
