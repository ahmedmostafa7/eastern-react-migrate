...
class propertyRemovalComponent extends Component {
  constructor(props) {
    ...
    this.parcel_fields = this.props.parcel_fields || [
      ...
      { name: "PARCEL_CUT_AREA", editable: true },
    ];
                ...
                <div>
                  ...
                  >
                    <tbody>
                      <tr key="r1">
                        <td>البلدية</td>
                        <td>{selectedLands[0].attributes.MUNICIPALITY_NAME}</td>

                        <td>المخطط</td>
                        <td>
                          {convertToArabic(selectedLands[0].attributes.PLAN_NO)}
                        </td>
                        ...
                        {
                          <>
                            <td>إجمالي مساحة النزع المطلوبة (م٢)</td>
                            <td>
                              {convertToArabic(
                                selectedLands
                                  .map((parcel) => {
