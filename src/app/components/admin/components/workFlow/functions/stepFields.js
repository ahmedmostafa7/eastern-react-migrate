...
export const stepFields = [
  {
    ...
    required: true,
    uniqueNameWithUrl: {
      id: "dialog.workFlowId",
      url: "/Steps/uniqueName",
      //name_key: 'key',
      value_key: "q",
    },
  },
  ...
  //     label_key: 'name',
  //     value_key: 'value',
  //     permission: {show_include_value_array: { steps_actions: ["global.APPROVE", "global.FINISH", "global.SUBMIT","global.APPROVE"]}},
  ...
  //     type:'boolean',
  //     permission:{
  //         show_include_value_array: { steps_actions: ["global.APPROVE", "global.APPROVE"]}
  //     }
  // },
  {
    name: "scalation",
