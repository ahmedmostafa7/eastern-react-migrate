...
export default {
  ...
  className: "khetab",
  sections: {
    approved_prepare_decision_print: {
      label: "قرار البدء في الاجراءات",
      className: "radio_det",
      fields: {
        prepare_decision_attachment: {
          label: "مرفق قرار البدء في الاجراءات",
        ...
        print: {
          label: "طباعة قرار البدء في الاجراءات",
          //hideLabel: true,
          field: "button",
          className: "botnPrint",
          text: "طباعة",
          action: {
            ...
            action(props, d, stepItem) {
              ...
              // ).then(() =>
              window.open(
                printHost + `/#/init_procedure_print/${id}`,
                "_blank"
              );
              // );
            },
