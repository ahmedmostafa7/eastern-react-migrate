...
export default {
  ...
  sections: {
    printed_remarks: {
      ...
      fields: {
        plan_desc: {
          moduleName: "plan_desc",
          label: "وصف المخطط",
          placeholder: "من فضلك ادخل وصف المخطط",
          required: true,
          field: "text",
          permission: {
            // show_match_value: { planStatus: 2 }
            hide_if_props_equal: { key: "currentModule.id", value: 120 },
          },
        },
        printType: {
                ...
                edit: {
                  permissions: {
                    ...
                    show_multiValues_equal_list: {
                      con1: [
                        { key: "addedIn120", value: undefined },
                        { key: "currentModule.id", value: 100 },
                      ],
                      con2: [
                        { key: "addedIn120", value: undefined },
                        { key: "currentModule.id", value: 42 },
                      ],
                      con3: [
                        { key: "addedIn120", value: true },
                    ...
                    props.setMain("Popup", {
                      popup: {
                        ...
                        childProps: {
                          ...
                          ok(values) {
                            let data =
                              (props["values"] && props?.values?.remarks) ||
