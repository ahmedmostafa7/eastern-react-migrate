...
export default class Gov_TempA0 extends Component {
  state = {
    data: [],
  ...
  setPrintValues = (submissionData, mainObject) => {
    ...
    let creator_eng_comp = get(submissionData, "CreatorUser.engcompany_id", "");
    let creator_emp = get(submissionData, "CreatorUser.department_id", "");
    ...
    //
    let attachments =
      (this.state.mainObject?.gov_requests || this.state.mainObject?.requests)
                    ...
                    this.setState({
                      ...
                      msa7yImage:
                        this.state["btnPrint"] != "رجوع"
                          ? (mainObject?.gov_requests || mainObject?.requests)
                              ?.requests?.attachment_img
                          : tempMsa7yImage,
                    });
                  ...
                  >
                    ...
                    <Col span={6}>
                      <div style={{ paddingLeft: "10px" }}>
                        <p>مخطط أرض / </p>
                        <p>
                          {plan_description} بالمعاملة رقم{" "}
                      ...
                      {!imported_mainObject && (
                        <Col span={18}>
                          ...
                          >
                            ...
                            {creator_eng_comp != null && (
                              <tr>
                                <td>المكتب الهندسي المصمم</td>
                                <td colSpan="2">{creator_user_name}</td>
                              </tr>
                            )}
                            {creator_emp == 228 && province_id && (
                              <tr>
                                <td>مقدم الطلب (بإدارة المساحة)</td>
                                <td colSpan="2">{creator_user_name}</td>
                              </tr>
                            )}
                            {/* {isMMSignShow && ( */}
