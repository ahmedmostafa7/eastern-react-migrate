    ...
    initializeSubmissionData(this.props.params.id).then((response) => {
      followUp({ ...this.props.params }, 0, {}, null, false, this.props).then(
        (res) => {
          ...
          let title1 =
            response?.printObj?.printTextEdited?.ministryReport?.title1;
          this.setState({
            printObj: printObj,
            title1: title1,
          });
          ...
          <div className="printContent mohand_font_not_bold">
            <header>
              <div className="first_section">
                ...
                <h5 className="headerpadding" style={{ marginRight: "40px" }}>
                  {" "}
                  إدارة التخطيـط
                </h5>
              </div>
              ...
              <div className="printFooter">
                ...
                <ZoomSlider>
                  <div className="heads">
                    ...
                    <h6>
                      - فرع وزارة البيئة والمياه والزراعة بالمنطقة الشرقية مع
                      نسخة من المخطط .
                    </h6>
                    <h6>
