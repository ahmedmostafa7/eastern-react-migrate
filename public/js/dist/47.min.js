...
/***/ "./src/app/components/inputs/fields/selectedParcels/Component/farz_parcels.js":
/*!************************************************************************************!*\
  !*** ./src/app/components/inputs/fields/selectedParcels/Component/farz_parcels.js ***!
  \************************************************************************************/
...
/* harmony import */ var _mapping__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mapping */ "./src/app/components/inputs/fields/selectedParcels/Component/mapping.js");
...
/* harmony import */ var _helpers_apiMethods__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../../helpers/apiMethods */ "./src/app/helpers/apiMethods/index.js");
...
/* harmony import */ var _reducers__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../../../reducers */ "./src/app/reducers/index.js");
/* harmony import */ var _identify_Component_common_common_func__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../identify/Component/common/common_func */ "./src/app/components/inputs/fields/identify/Component/common/common_func.js");
/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./style.css */ "./src/app/components/inputs/fields/selectedParcels/Component/style.css");
...
class farzParcelsComponent extends react__WEBPACK_IMPORTED_MODULE_6__["Component"] {
  constructor(props) {
    super(props);
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "addParcel", item => {
      const {
        input,
        onResetParcelDesc,
        values
      } = this.props;
      var parcel_desc = lodash_get__WEBPACK_IMPORTED_MODULE_5___default()(values, "PARCEL_NO", "");
      if (!_.find(this.parcels, function (d) {
        ...
        this.parcels.push({
          attributes: {
            ...
            NEW_PARCEL_AREA: "",
            PARCEL_SPATIAL_ID: Object(_identify_Component_common_common_func__WEBPACK_IMPORTED_MODULE_14__["generateUUID"])(),
            MUNICIPALITY_NAME_Code: lodash_get__WEBPACK_IMPORTED_MODULE_5___default()(values, "municipality_id", ""),
            PARCEL_AREA: ""
          }
        });
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "remove", item => {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "openPopup", scope => {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "myChangeHandler", (name, i, e, event) => {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "selectOnchange", (name, i, e, value) => {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "showEditBtn", (name, value) => {
      return ["NEW_PARCEL_AREA", "USING_SYMBOL_SELECT"].indexOf(name) > -1;
    });
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4___default()(this, "enableEdit", (name, i) => {
      this.setState({
        [name + "_isEdit_" + i]: true
      });
    });
    ...
    Object(_helpers_apiMethods__WEBPACK_IMPORTED_MODULE_9__["fetchData"])(`${workFlowUrl}/Symbols/GetAll`).then(response => {
      this.parcel_fields[2].options = response.results;
      Object(_helpers_apiMethods__WEBPACK_IMPORTED_MODULE_9__["fetchData"])(`${backEndUrlforMap}${response.next}`).then(data => {
        this.parcel_fields[2].options = this.parcel_fields[2].options.concat(data.results);
      });
    });
  }
  UpdateStore(parcels) {
    ...
    if ([23].indexOf(this.props.currentModule.id) != -1 || [1968].indexOf(this.props.currentModule.record.workflow_id) != -1) landsData["selectedRequestType"] = this.props.selectedRequestType;
  ...
  saveEdit(id, name, i, fieldNameToBeShown) {
    ...
    if (fieldNameToBeShown) {
      if (findParcel.attributes.USING_SYMBOL_SELECT) {
        ...
        if (findParcel.attributes.USING_SYMBOL_SELECT && !findParcel.attributes.USING_SYMBOL_CODE) {
          findParcel.attributes.USING_SYMBOL = findParcel.attributes.USING_SYMBOL_SELECT;
        } else {
          findParcel.attributes.USING_SYMBOL_TEXT = findParcel.attributes.USING_SYMBOL_SELECT;
        }
  ...
  render() {
    ...
    var uploadedImage = lodash_get__WEBPACK_IMPORTED_MODULE_5___default()(values, "image_uploader", "");
    var PARCEL_NO = lodash_get__WEBPACK_IMPORTED_MODULE_5___default()(values, "PARCEL_NO", "");
    var MUNICIPALITY = lodash_get__WEBPACK_IMPORTED_MODULE_5___default()(values, "MUNICIPALITY", "");
    var parcelBtnDisabled = false;
    if ([23].indexOf(this.props.currentModule.id) != -1 || [1968].indexOf(this.props.currentModule.record.workflow_id) != -1 && selectedRequestType == 1 && parcels.length > 0) {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("div", {
      ...
      className: "add-gis",
      disabled: !uploadedImage || !PARCEL_NO || !MUNICIPALITY || parcelBtnDisabled,
      onClick: this.addParcel.bind(this)
    }, "\u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0623\u0631\u0636"), parcels && parcels.length > 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("h1", {
      ...
      return !field_header.hidden && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("th", null, field_header.label);
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("th", null, " \u062E\u064A\u0627\u0631\u0627\u062A"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("tbody", null, parcels.map((e, i) => {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("tr", {
        key: i
      }, this.parcel_fields.map((field, k) => {
        return !field.hidden && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("td", {
          key: k
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("div", null, field.editable ? !this.state[field.name + "_isEdit_" + i] ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("span", null, Object(_identify_Component_common_common_func__WEBPACK_IMPORTED_MODULE_14__["convertToArabic"])(e.attributes[field.name] || "")), this.showEditBtn(field.name, e.attributes[field.name]) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("button", {
          className: "btn",
          style: {
        ...
        }, field.type != "select" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("input", {
          key: i,
        ...
        }), field.type == "select" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(antd_lib_select__WEBPACK_IMPORTED_MODULE_1___default.a, {
          ...
          filterOption: (input, option) => {
            if (option.props.children) {
              ...
              return ((_option$props$childre = option.props.children) === null || _option$props$childre === void 0 ? void 0 : (_option$props$childre2 = _option$props$childre.toLowerCase()) === null || _option$props$childre2 === void 0 ? void 0 : _option$props$childre2.indexOf(Object(_identify_Component_common_common_func__WEBPACK_IMPORTED_MODULE_14__["convertToArabic"])(input.toLowerCase()))) != -1;
            } else {
              return false;
            }
          }
        }, field.options.map((f, x) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(Option, {
          key: f.id,
          value: f.name
        }, Object(_identify_Component_common_common_func__WEBPACK_IMPORTED_MODULE_14__["convertToArabic"])(f.name)))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("button", {
          className: "btn",
          style: {
            marginRight: "20px"
          },
          onClick: this.saveEdit.bind(this, e.attributes.PARCEL_SPATIAL_ID, field.name, i, field.toBeShown)
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("i", {
          className: "fa fa-floppy-o"
        }))) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("span", null, Object(_identify_Component_common_common_func__WEBPACK_IMPORTED_MODULE_14__["convertToArabic"])(e.attributes[field.name] || "")))));
      }), i === parcels.length - 1 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("td", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("button", {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_10__["connect"])(_mapping__WEBPACK_IMPORTED_MODULE_7__["mapStateToProps"], _main_helpers_actions_main__WEBPACK_IMPORTED_MODULE_8__["default"])(farzParcelsComponent));
