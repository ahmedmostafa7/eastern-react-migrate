(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  [70],
  {
    /***/ "./src/app/components/inputs/fields/identify/Component/SurveyIdentifyComponnent/Helpers.js":
      /*!*************************************************************************************************!*\
  !*** ./src/app/components/inputs/fields/identify/Component/SurveyIdentifyComponnent/Helpers.js ***!
  \*************************************************************************************************/
    ...
    /***/ "./src/app/components/inputs/fields/identify/Component/SurveyIdentifyComponnent/index.js":
      /*!***********************************************************************************************!*\
  !*** ./src/app/components/inputs/fields/identify/Component/SurveyIdentifyComponnent/index.js ***!
  \***********************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _imports_config__WEBPACK_IMPORTED_MODULE_8__ =
          __webpack_require__(
        ...
        /* harmony import */ var _Helpers__WEBPACK_IMPORTED_MODULE_18__ =
          __webpack_require__(
            /*! ./Helpers */ "./src/app/components/inputs/fields/identify/Component/SurveyIdentifyComponnent/Helpers.js"
          );
        ...
        /* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_22__ =
          __webpack_require__(
        ...
        class SurveyIdentifyComponnent extends react__WEBPACK_IMPORTED_MODULE_6__[
          "Component"
        ] {
          constructor(props) {
            var _props$input,
          ...
          required: false,
                  ...
                  this.parcel_fields_headers = [
                    ...this.parcel_fields_headers.filter(
                      (x) => x != "عدد الوحدات"
                    ),
                  ];
                  this.parcel_fields = [
                    ...this.parcel_fields.filter(
                      (x) => x.name != "UNITS_NUMBER"
                    ),
                  ];
                } else {
                  ...
                  this.state.selectedLands.forEach((parcel) => {
                    var _parcel$parcelElectri, _parcel$parcelShatfa;
                    (_parcel$parcelElectri = parcel.parcelElectric) === null ||
                    _parcel$parcelElectri === void 0
                      ? true
                      : delete _parcel$parcelElectri.isSubtractArea;
                    (_parcel$parcelShatfa = parcel.parcelShatfa) === null ||
                    _parcel$parcelShatfa === void 0
                      ? true
                      : delete _parcel$parcelShatfa.isSubtractArea;
                  });
                  if (
                    !this.parcel_fields_headers.find((x) => x == "عدد الوحدات")
                  ) {
                    this.parcel_fields_headers.push("عدد الوحدات");
                    this.parcel_fields.push({
                      name: "UNITS_NUMBER",
                      editable: false,
                    });
                  }
            ...
            _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(
              ...
              (item) => {
                ...
                return new Promise((resolve, reject) => {
                  var _item$attributes$MUNI;
                  axios__WEBPACK_IMPORTED_MODULE_21___default.a
                    .post(
                      _imports_config__WEBPACK_IMPORTED_MODULE_8__["host"] +
                        "/IsHasSubmission/" +
                        ...
                        (this.props.currentModule.record.id || 0),
                      {
                        ...
                        municipilty_code:
                          ...
                          ((_item$attributes$MUNI =
                            item.attributes.MUNICIPALITY_NAME) === null ||
                          _item$attributes$MUNI === void 0
                            ? void 0
                            : _item$attributes$MUNI.code) ||
            ...
            _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(
              ...
              () => {
                ...
                if (
                  ...
                  axios__WEBPACK_IMPORTED_MODULE_21___default.a
                    .get(
                      `${_imports_config__WEBPACK_IMPORTED_MODULE_8__["workFlowUrl"]}/Land/HasSurveyCheckRequest?spatialId=${this.state.parcelId}`
                    )
                    .then(({ data }) => {
                      if (data.hasSurveyCheckRequest) {
                        if (data.submissions[0].status == 1) {
                          var _this$props$currentMo3, _this$props$currentMo4;
                          if (
                            ((_this$props$currentMo3 =
                              this.props.currentModule) === null ||
                            _this$props$currentMo3 === void 0
                              ? void 0
                              : (_this$props$currentMo4 =
                                  _this$props$currentMo3.record) === null ||
                                _this$props$currentMo4 === void 0
                              ? void 0
                              : _this$props$currentMo4.request_no) !=
                          ...
                          axios__WEBPACK_IMPORTED_MODULE_21___default.a
                            .get(
                              `${_imports_config__WEBPACK_IMPORTED_MODULE_8__["workFlowUrl"]}/Land/HasRIdRequest?spatialId=${this.state.parcelId}`
                            )
                            .then((res) => {
              ...
              (r) => {
                ...
                if (r) {
                  if (r[0].attributes.isTadkeekBefore) {
                    r[0].attributes.PARCEL_AREA = (+r[0].attributes
        ...
        this.map.getLayer("SelectGraphicLayer").add(graphic);
                ...
                Object(
                  ...
                  returnGeometry: true,
                  callbackResult: (res) => {
                    var _res$features, _res$features$;
                    f.geometry =
                      res === null || res === void 0
                        ? void 0
                        : (_res$features = res.features) === null ||
                          _res$features === void 0
                        ? void 0
                        : (_res$features$ = _res$features[0]) === null ||
                          _res$features$ === void 0
                        ? void 0
                        : _res$features$.geometry;
                    Object(
                      _common_common_func__WEBPACK_IMPORTED_MODULE_9__[
                        "highlightFeature"
                      ]
                    )(res.features, this.map, {
            ...
            _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(
              ...
              (f) => {
                ...
                if (
                  !(
                    (_this$state$selectedL = this.state.selectedLands) !==
                      null &&
                    _this$state$selectedL !== void 0 &&
                    _this$state$selectedL.length
                  ) &&
                  [1].indexOf(
                ...
                this.props.setMain("Popup", {
                  popup: {
                    ...
                    childProps: {
                      fields,
                      initialValues: {
                        ...scope.state.selectedLands[index].parcelElectric,
                      },
                      ok(values) {
                        scope.state.selectedLands[index].parcelElectric =
                          values;
                ...
                this.props.setMain("Popup", {
                  popup: {
                    ...
                    childProps: {
                      fields,
                      initialValues: {
                        ...scope.state.selectedLands[index].parcelShatfa,
                      },
                      ok(values) {
                ...
                this.props.setMain("Popup", {
                  popup: {
                    ...
                    childProps: {
                      fields,
                      initialValues: {
                        ...scope.state.selectedLands[index].parcelData,
                      },
                      ok(values) {
            ...
            if (
              (props === null || props === void 0
                ...
                ? void 0
                : _props$input3$value.selectedMoamlaType) == 1
            ) {
              this.parcel_fields_headers.push("عدد الوحدات");
              this.parcel_fields.push({
                name: "UNITS_NUMBER",
            ...
            this.checkUnitNumberAvailability(
              ...
              props === null || props === void 0
                ...
                ? void 0
                : (_props$input4$value$t = _props$input4$value.temp) === null ||
                  _props$input4$value$t === void 0
                ? void 0
                : _props$input4$value$t.mun
            );
            ...
            Object(
              _common_common_func__WEBPACK_IMPORTED_MODULE_9__["map_object"]
            )(props.input && props.input.value.parcels);
            this.state = {
              ...
              requestTypes: [
                {
                  code: 1,
                  name: "فرز ودمج الأراضي",
                  key: "",
                },
                {
                  code: 2,
                  name: "تحديث وفرز الصكوك",
                  key: "",
                },
              ...
              selectedMoamlaType:
                props === null || props === void 0
                  ...
                  ? void 0
                  : _props$input5$value.selectedMoamlaType,
              selected_Req_type:
                props === null || props === void 0
                  ? void 0
                  : (_props$input6 = props.input) === null ||
                    _props$input6 === void 0
                  ? void 0
                  : (_props$input6$value = _props$input6.value) === null ||
                    _props$input6$value === void 0
                  ? void 0
                  : _props$input6$value.selected_Req_type,
              selectedRequestType:
                (props === null || props === void 0
                  ? void 0
                  : (_props$input7 = props.input) === null ||
                    _props$input7 === void 0
                  ? void 0
                  : (_props$input7$value = _props$input7.value) === null ||
                    _props$input7$value === void 0
                  ? void 0
                  : _props$input7$value.selectedRequestType) ||
                ([2190, 2191].indexOf(
              ...
              city_name:
                props === null || props === void 0
                  ? void 0
                  : (_props$input8 = props.input) === null ||
                    _props$input8 === void 0
                  ? void 0
                  : (_props$input8$value = _props$input8.value) === null ||
                    _props$input8$value === void 0
                  ? void 0
                  : (_props$input8$value$t = _props$input8$value.temp) ===
                      null || _props$input8$value$t === void 0
                  ? void 0
                  : _props$input8$value$t.city_name,
        ...
        required: false,
          ...
          componentDidMount() {
            if (
              ...
              Object(
                _common_common_func__WEBPACK_IMPORTED_MODULE_9__["getInfo"]
              )().then((res) => {
                this.LayerID = res;
                Object(_common__WEBPACK_IMPORTED_MODULE_22__["getParcels"])(
                  this,
                  null,
                  "",
                  {
                    ...
                    this.setState(
                      ...
                      () => {
                        ...
                        if (this.state.munval) {
                          Object(
                            _common__WEBPACK_IMPORTED_MODULE_22__["onMunChange"]
                          )(this, this.state.munval, () => {
                            Object(
                              _common__WEBPACK_IMPORTED_MODULE_22__[
                                "onPlaneChange"
                              ]
                      ...
                      /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(
                        antd_lib_select__WEBPACK_IMPORTED_MODULE_5___default.a,
                        {
                          ...
                          onSearch: (e) => {
                            ...
                            Object(
                              _common__WEBPACK_IMPORTED_MODULE_22__["onSearch"]
                            )(this, e);
                          },
                          filterOption: (input, option) => {
                            if (option.props.children) {
