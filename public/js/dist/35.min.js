...
/***/ "./src/app/components/wizard/components/stepContent/sections/sectionTypes/wizardSummery/components/conditions.js":
/*!***********************************************************************************************************************!*\
  !*** ./src/app/components/wizard/components/stepContent/sections/sectionTypes/wizardSummery/components/conditions.js ***!
  \***********************************************************************************************************************/
...
/* harmony import */ var _helpers_modules_service_conditions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../../../../helpers/modules/service/conditions */ "./src/app/helpers/modules/service/conditions.js");
/* harmony import */ var _helpers_components_show__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../../../../helpers/components/show */ "./src/app/helpers/components/show/index.js");
/* harmony import */ var _helpers_functions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../../../../../helpers/functions */ "./src/app/helpers/functions/index.js");
...
const fields = {
  conditions: _helpers_modules_service_conditions__WEBPACK_IMPORTED_MODULE_5__["Summary"].sections.conditions.fields
};
class submission extends react__WEBPACK_IMPORTED_MODULE_4__["Component"] {
  constructor(props) {
    super(props);
    //
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "renderInfo", (data, field, key) => {
      ...
      if (["utility_same_distance", "utility_opposite_distance"].indexOf(key) != -1) {
        let value = lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(data, key);
        if (typeof value == "object") {
          value = value.inputValue && `${value.inputValue} ${value.extValue || ''}` || '';
        }
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_helpers_components_show__WEBPACK_IMPORTED_MODULE_6__["default"], {
          field: field,
          val: value,
          key: key
        });
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_helpers_components_show__WEBPACK_IMPORTED_MODULE_6__["default"], {
        field: field,
        val: lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(data, key),
        key: key
      });
    });
    this.fields = lodash_pickBy__WEBPACK_IMPORTED_MODULE_1___default()(fields.conditions, field => {
      return Object(_helpers_functions__WEBPACK_IMPORTED_MODULE_7__["apply_field_permission"])(submission, field, this.props);
    });
  }
  render() {
    const {
      conditions
    } = this.props.mainObject.Conditions;
    // console.log(fields.conditions)
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_4___default.a.Fragment, null, lodash_map__WEBPACK_IMPORTED_MODULE_2___default()(this.fields, this.renderInfo.bind(this, conditions)));
  }
}
