...
/***/ "./src/app/components/wizard/components/stepContent/sections/sectionTypes/wizardSummery/components/service_sub_type.js":
/*!*****************************************************************************************************************************!*\
  !*** ./src/app/components/wizard/components/stepContent/sections/sectionTypes/wizardSummery/components/service_sub_type.js ***!
  \*****************************************************************************************************************************/
...
/* harmony import */ var _helpers_modules_service_type__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../../../../helpers/modules/service/type */ "./src/app/helpers/modules/service/type.js");
...
const fields = {
  ..._helpers_modules_service_type__WEBPACK_IMPORTED_MODULE_6__["default"].sections.submission.fields
};
class submission extends react__WEBPACK_IMPORTED_MODULE_4__["Component"] {
  constructor(props) {
    super(props);
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "renderInfo", (field, key) => {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_helpers_components_show__WEBPACK_IMPORTED_MODULE_5__["default"], {
        field: field,
        val: lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(this.data, field.name || key),
        key: key,
        values: this.data
      });
    });
    const {
      submission
    } = this.props.mainObject.serviceSubmissionType;
    this.data = submission;
    this.fields = lodash_pickBy__WEBPACK_IMPORTED_MODULE_1___default()(fields, field => {
      return Object(_helpers_functions__WEBPACK_IMPORTED_MODULE_7__["apply_field_permission"])(submission, field, this.props);
    });
    console.log(this.fields);
  }
  render() {
    return lodash_map__WEBPACK_IMPORTED_MODULE_2___default()(this.fields, this.renderInfo);
  }
}
