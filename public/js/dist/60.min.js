...
/***/ "./src/app/helpers/components/show/select/multiSelect.js":
/*!***************************************************************!*\
  !*** ./src/app/helpers/components/show/select/multiSelect.js ***!
  \***************************************************************/
/*! exports provided: multiSelect, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _mapping__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mapping */ "./src/app/helpers/components/show/select/mapping.js");
/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./main */ "./src/app/helpers/components/show/select/main.js");
...
class multiSelectComponent extends _main__WEBPACK_IMPORTED_MODULE_6__["selectComponent"] {
  render() {
    const {
      val,
      field,
    ...
    const shows = lodash_map__WEBPACK_IMPORTED_MODULE_1___default()(val, d => {
      const md = lodash_find__WEBPACK_IMPORTED_MODULE_0___default()(data, {
        [field.value_key || "value"]: d
      });
      return t(lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(md, field.label_key || "label"));
    });
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("p", null, shows.join(","));
  }
}
const multiSelect = Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["connect"])(_mapping__WEBPACK_IMPORTED_MODULE_5__["mapStateToProps"], _mapping__WEBPACK_IMPORTED_MODULE_5__["mapDispatchToProps"])(Object(react_i18next__WEBPACK_IMPORTED_MODULE_7__["translate"])("labels")(multiSelectComponent));
