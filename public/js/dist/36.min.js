...
/***/ "./src/app/components/wizard/components/stepContent/sections/sectionTypes/wizardSummery/components/lagna_notes.js":
/*!************************************************************************************************************************!*\
  !*** ./src/app/components/wizard/components/stepContent/sections/sectionTypes/wizardSummery/components/lagna_notes.js ***!
  \************************************************************************************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return lagnaNotes; });
...
/* harmony import */ var _helpers_components_show__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../../../../helpers/components/show */ "./src/app/helpers/components/show/index.js");
/* harmony import */ var _app_components_wizard_modulesObjects_plan_approval_steps_going_survey_review_approval_details_module_lagna_notes_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../../../../../app/components/wizard/modulesObjects/plan_approval/steps/going_survey_review_approval_details_module/lagna_notes.js */ "./src/app/components/wizard/modulesObjects/plan_approval/steps/going_survey_review_approval_details_module/lagna_notes.js");
/* harmony import */ var _inputs_fields_identify_Component_common_common_func_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../../../inputs/fields/identify/Component/common/common_func.js */ "./src/app/components/inputs/fields/identify/Component/common/common_func.js");
...
class lagnaNotes extends react__WEBPACK_IMPORTED_MODULE_3__["Component"] {
  constructor(props) {
    super(props);
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "renderInfo", (data, field, key) => {
      var _field$fields;
      field === null || field === void 0 ? true : (_field$fields = field.fields) === null || _field$fields === void 0 ? true : delete _field$fields.actions;
      if (field.field != "button") {
        if (field.field == "list") {
          ...
          let remarks = lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(data, key, []).map(remark => ({
            ...remark,
            remark: Object(_inputs_fields_identify_Component_common_common_func_js__WEBPACK_IMPORTED_MODULE_6__["convertToArabic"])(remark.remark)
          }));
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_helpers_components_show__WEBPACK_IMPORTED_MODULE_4__["default"], {
            field: field,
            val: remarks,
            key: key
          });
        ...
        if (field.field == "text") {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_helpers_components_show__WEBPACK_IMPORTED_MODULE_4__["default"], {
            field: field,
            val: Object(_inputs_fields_identify_Component_common_common_func_js__WEBPACK_IMPORTED_MODULE_6__["convertToArabic"])(lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(data, key)),
            key: key
          });
        }
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_helpers_components_show__WEBPACK_IMPORTED_MODULE_4__["default"], {
          field: field,
          val: lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(data, key),
          key: key
        });
      }
    });
  ...
  render() {
    const {
      lagna_remarks
    } = this.props.mainObject.lagna_notes;
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, lodash_map__WEBPACK_IMPORTED_MODULE_1___default()(_app_components_wizard_modulesObjects_plan_approval_steps_going_survey_review_approval_details_module_lagna_notes_js__WEBPACK_IMPORTED_MODULE_5__["default"].sections.lagna_remarks.fields, this.renderInfo.bind(this, lagna_remarks)));
  }
}
...
/***/ "./src/app/helpers/components/show/index.js":
/*!**************************************************!*\
  !*** ./src/app/helpers/components/show/index.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony import */ var _main_helpers_functions_filters__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../main_helpers/functions/filters */ "./src/main_helpers/functions/filters/index.js");
/* harmony import */ var _show__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./show */ "./src/app/helpers/components/show/show.js");




class ShowField extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  componentDidMount() {
    const {
      values
    } = this.props;
  ...
  render() {
    ...
    label = field.label_state ? Object(_main_helpers_functions_filters__WEBPACK_IMPORTED_MODULE_2__["default"])({
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      className: "uu"
    }, !field.hideLabel && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      className: "table-div"
    ...
    }, t(label))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_show__WEBPACK_IMPORTED_MODULE_3__["default"], this.props))) || /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_show__WEBPACK_IMPORTED_MODULE_3__["default"], this.props)));
  }
}
/* harmony default export */ __webpack_exports__["default"] = (Object(react_i18next__WEBPACK_IMPORTED_MODULE_1__["translate"])("labels")(ShowField));
...
/***/ "./src/app/helpers/components/show/show.js":
/*!*************************************************!*\
  !*** ./src/app/helpers/components/show/show.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ShowField; });
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./types */ "./src/app/helpers/components/show/types.js");




class ShowField extends react__WEBPACK_IMPORTED_MODULE_2__["Component"] {
  render() {
    const {
      field
    } = this.props;
    const FComponent = lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(_types__WEBPACK_IMPORTED_MODULE_3__, field.field || field, _types__WEBPACK_IMPORTED_MODULE_3__["label"]);
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2__["Suspense"], {
      fallback: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null)
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(FComponent, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, this.props, {
      ShowField: ShowField
    })));
  }
}
