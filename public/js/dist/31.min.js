...
/***/ "./src/app/components/wizard/components/stepContent/sections/sectionTypes/wizardSummery/components/approval_notes.js":
/*!***************************************************************************************************************************!*\
  !*** ./src/app/components/wizard/components/stepContent/sections/sectionTypes/wizardSummery/components/approval_notes.js ***!
  \***************************************************************************************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return approvalSubmissionNotes; });
...
/* harmony import */ var moment_hijri__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! moment-hijri */ "./node_modules/moment-hijri/moment-hijri.js");
/* harmony import */ var moment_hijri__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(moment_hijri__WEBPACK_IMPORTED_MODULE_5__);
...
class approvalSubmissionNotes extends react__WEBPACK_IMPORTED_MODULE_3__["Component"] {
  constructor(props) {
    super(props);
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "renderInfo", (field, key) => {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_helpers_components_show__WEBPACK_IMPORTED_MODULE_4__["default"], {
        field: field,
        val: lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(this.data, key),
        key: key
      });
    });
    const {
    ...
    let newNotes = {
      ...notes,
      date: Object(moment_hijri__WEBPACK_IMPORTED_MODULE_5__["moment"])().format("iYYYY-iMM-iD")
    };
    this.data = notes;
  }
  render() {
    console.log("ggtgt", fields, this.renderInfo);
    return lodash_map__WEBPACK_IMPORTED_MODULE_1___default()(fields, this.renderInfo);
  }
}
